...
call jlink --no-header-files --no-man-pages --compress=2 --strip-debug --module-path modules;%cd%\compilerModule\build\libs;%cd%\openjdk-17.0.2\linux_x64\jmods --add-modules core,compilerModule --output ..\bin\linux || goto :error
echo JRE created
